...
const Contact = () => {
    return (
        <div class="my-6">
            <div class="grid sm:grid-cols-1  lg:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl  rounded-md text-[#333] font-[sans-serif]">
                <div>
                ...
                <form class="ml-auo space-y-4">
                    ...
                    <button type='button'
                        class="text-white bg-[#d97706] hover:bg-[#b45309] font-semibold rounded-md text-sm px-4 py-2.5 w-full">Send</button>
                </form>
            </div>
        </div>
    )
